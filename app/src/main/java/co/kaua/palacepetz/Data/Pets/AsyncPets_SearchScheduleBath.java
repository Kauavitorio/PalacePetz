...
public class AsyncPets_SearchScheduleBath extends AsyncTask {
    ArrayList<String> arrayListDto = new ArrayList<>();
    Activity context;
    int _IdUser;
    LoadingDialog loadingDialog;

    public AsyncPets_SearchScheduleBath(int _IdUser, Activity context) {
    ...
    protected void onPostExecute(Object arrayListDto) {
        ...
        ScheduleBathAndTosaActivity.getInstance().UpdateSearch((ArrayList<String>) arrayListDto);
    }
}
